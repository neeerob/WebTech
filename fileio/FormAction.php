...
<body>
	...
	if($_SERVER['REQUEST_METHOD'] === "POST"){
		...
		if(empty($firstname) or empty($lastname) or empty($gender) or empty($DOB) or empty($religion) or empty($present_Address) or empty($permanent_Address) or empty($phone) or empty($email) or empty($webPage) or empty($userName) or empty($password)){
			$isValid = false;
		}
		...
		if($isValid == true){
			...
			if (empty($present_Address)){
				echo "<li>Present Address is not given (* Requred -> Fill Information)<br> <br>";
				
			}
			else {
				echo "Present Address is: $present_Address <br> <br>";
			}

			if (empty($permanent_Address)){
				echo "<li>Permanent Address is not given (* Requred -> Fill Information)<br> <br>";
				
			}
			else {
				echo "Permanent Address is: $permanent_Address <br> <br>";
			}

			if (empty($phone)){
				echo "<li>Phone Number is not given (* Requred -> Fill Information)<br> <br>";
				
			}
			else {
				echo "Phone Number is: $Phone <br> <br>";
			}
			...
			if (empty($webPage)){
				echo "<li>Web Page is not given (* Requred -> Fill Information)<br> <br>";
				
			}
			else {
				echo "Web Page is: $webPage <br> <br>";
			}
